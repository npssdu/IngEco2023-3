...
\include{W_Varios/0_Tablas_notacion/TablasEcuNom}
\include{0_Capitulo/guiaEjercicios}
\include{1_Capitulo/ch1}
\include{2_Capitulo/ch2}
\include{3_Capitulo/ch3}
\include{4_Capitulo/ch4}
\include{5_Capitulo/ch5}
\include{6_Capitulo/ch6}
\include{7_Capitulo/ch7}
\include{8_Capitulo/ch8}
\include{9_Capitulo/ch9}
\include{10_Capitulo/ch10}
\include{11_Capitulo/ch11}
\include{12_Capitulo/ch12}

\include{A_Capitulo_Ejercicios/chE}
\include{B_Capitulo_Glosario/glosario}
\include{B1_Capitulo_Creditos/creditos}
\include{C_Capitulo_Anexos/chAnexos}
